        ...
        <div className="glass p-6 sm:p-10 text-center space-y-6 sm:space-y-8 max-w-full sm:max-w-md">
          ...
          >
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 bg-purple-600 hover:bg-purple-500 text-white font-extrabold py-4 rounded-2xl text-lg transition-all duration-200 shadow-[0_0_30px_rgba(168,85,247,0.4)] hover:shadow-[0_0_50px_rgba(168,85,247,0.6)] border border-purple-400/20"
            >
