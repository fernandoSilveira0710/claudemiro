    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-pink-800 to-orange-700">
      ...
      >
        ...
        <p className="text-xl text-white/70 max-w-md mx-auto">
          Conecte suas redes e descubra quem você é de verdade
        </p>
        <motion.div
        ...
        >
          <Button
            ...
            className="bg-white text-purple-900 hover:bg-white/90 font-bold px-10 py-7 text-lg rounded-2xl shadow-2xl"
          >
        ...
        <p className="text-sm text-white/40">
          Ao entrar, você concorda com ser julgado pelo Claudemiro
        </p>
      </motion.div>
    </div>
  )
